...
public class Config {
     ...
     */
    public static class OrmliteDatabaseConfigUtil extends OrmLiteConfigUtil {

        /**
         * classes represents the models to use for generating the ormlite_config.txt file
         */
        private static final Class<?>[] classes = new Class[] {Categoria.class,Cliente.class,Pedido.class, PedidoProducto.class,Producto.class,Usuario.class};
